  ...
  return (
    <div className="space-y-5">
      ...
      <div ref={revealRef} className="reveal glass-strong rounded-3xl p-6 text-center relative overflow-hidden">
        ...
        <div className="relative">
          <div
            className="w-24 h-24 mx-auto rounded-3xl flex items-center justify-center text-5xl mb-3 rank-badge-float"
            style={{ background: `${data.rank.color}22`, border: `1px solid ${data.rank.color}55`, boxShadow: `0 0 30px ${data.rank.color}33` }}
          >
            {data.rank.emoji}
          </div>
