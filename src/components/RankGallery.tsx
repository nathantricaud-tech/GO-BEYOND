  ...
  if (loadError) {
    return (
      <div className="glass-strong rounded-3xl p-8 text-center space-y-3">
        ...
        <p className="text-sm text-gray-400">Impossible de charger ton rang pour le moment.</p>
        <button
  ...
  return (
    <div className="space-y-5">
        ...
        <div className="relative">
          ...
          {data.nextRank ? (
            ...
            <p className="mt-4 text-sm font-medium" style={{ color: data.rank.color }}>
              💥 Rang maximum atteint — tu es allé Plus Ultra.
            </p>
          )}
      ...
      <div className="glass rounded-2xl p-4">
        <h3 className="text-sm font-semibold text-gray-300 mb-2 flex items-center gap-2"><span>❓</span> Comment gagner des points ?</h3>
        <ul className="space-y-1.5 text-xs text-gray-400">
          <li>• <span className="text-white font-medium">+10 pts</span> — jour "complet" : au moins un repas <em>et</em> une séance loggés le même jour</li>
          <li>• <span className="text-white font-medium">+4 pts</span> — jour "partiel" : seulement un repas OU une séance ce jour-là</li>
          <li>• <span className="text-white font-medium">+{data.questBonusPoints} pts</span> — bonus si tu complètes la quête du jour ci-dessous</li>
        </ul>
        <p className="text-[11px] text-gray-500 mt-2">Les points sont cumulés à vie, rien n&apos;est jamais perdu. Monter de rang devient progressivement plus long : quelques jours pour les premiers rangs, plusieurs mois d&apos;assiduité pour atteindre HERO — et PLUS ULTRA, à 9000 points, est un objectif de très long terme réservé aux plus réguliers.</p>
      </div>
      ...
      <div className="glass-strong rounded-3xl p-5 relative overflow-hidden">
        ...
        >
          {data.questDoneToday ? "✓ Quête accomplie aujourd'hui" : completingQuest ? "..." : "Marquer comme fait"}
        </button>
      </div>
