    ...
    <div className="space-y-5">
      ...
      <div className="glass rounded-2xl p-4">
        ...
        <ul className="space-y-1.5 text-xs text-gray-400">
          <li>• <span className="text-white font-medium">+20 pts</span> — {lang === "fr" ? "dès qu\u2019une séance de sport est loggée ce jour-là" : "as soon as a workout is logged that day"}</li>
          <li>• <span className="text-white font-medium">+10 pts</span> — {lang === "fr" ? "dès qu\u2019un repas est loggé ce jour-là (les deux se cumulent : jusqu\u2019à 30 pts/jour)" : "as soon as a meal is logged that day (stacks: up to 30 pts/day)"}</li>
