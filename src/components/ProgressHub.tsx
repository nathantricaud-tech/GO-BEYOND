...
export default function ProgressHub({ profile, onWeightLogged }: { profile: Profile; onWeightLogged?: () => void }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div key={subTab} className="tab-transition">
        {subTab === "weight" && <WeightTracker profile={profile} onWeightLogged={onWeightLogged} />}
