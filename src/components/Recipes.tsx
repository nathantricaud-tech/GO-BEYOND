...
export default function Recipes({ userGoal, profileId }: { userGoal: string; profileId: number }) {
  const { lang } = useLang();
  const recipes = allRecipes.map((r) => translateRecipe(r, lang));
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-600/20 via-orange-600/10 to-red-600/20 p-6 border border-white/10">
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">Recettes Saines</h2>
        ...
        <div className="glass rounded-2xl p-5 border border-primary-500/20">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold text-primary-400 uppercase tracking-wider">
              Recommandé pour toi ({categoryLabels[userGoal] || categoryLabels.balanced})
            </h3>
          </div>
      ...
      {filteredRecipes.length === 0 && (
        <div className="text-center py-16 glass rounded-2xl">
          ...
          <p className="text-gray-300 font-medium">Aucune recette ne correspond à tes filtres</p>
          <p className="text-gray-500 text-sm mt-2">Essaie d’ajuster ta sélection</p>
          <button
            onClick={() => {
