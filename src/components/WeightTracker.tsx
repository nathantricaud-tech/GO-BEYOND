    ...
    <div className="space-y-6 animate-fade-in">
        ...
        <div className="relative">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-teal-300/80 text-sm">Track your progress over time</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="glass rounded-2xl p-5 text-center card-hover">
          ...
          <p className="text-xs text-gray-500 mt-1">Current (kg)</p>
        </div>
        {profile.targetWeight && (
          <div className="glass rounded-2xl p-5 text-center card-hover">
            ...
            <p className="text-xs text-gray-500 mt-1">Target (kg)</p>
          </div>
        )}
        <div className="glass rounded-2xl p-5 text-center card-hover">
          ...
          <p className="text-xs text-gray-500 mt-1">Change (kg)</p>
        </div>
        {profile.targetWeight && (
          <div className="glass rounded-2xl p-5 text-center card-hover">
        ...
        {showSuccess ? (
          <div className="flex items-center justify-center py-6 animate-scale-in">
            <div className="flex items-center gap-3 text-primary-400">
              ...
              <span className="font-semibold">Weight logged successfully!</span>
            </div>
          </div>
        ) : (
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3 flex-1">
              <button
                ...
                className="w-12 h-12 rounded-xl bg-white/10 hover:bg-white/20 text-white flex items-center justify-center text-xl font-bold transition-all active:scale-95"
              >
                −
              </button>
              <div className="relative flex-1">
                <input
                  ...
                  step="0.1"
                  className="w-full pl-4 pr-14 py-4 input-modern rounded-xl text-white text-right text-2xl font-bold focus:outline-none"
                />
                <span className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 font-medium text-xs bg-white/5 px-1.5 py-0.5 rounded-md">kg</span>
              </div>
              <button
            ...
            <button
              onClick={addEntry}
              disabled={adding}
              className="btn-primary px-8 py-4 rounded-xl text-white font-semibold disabled:opacity-60"
            >
              {adding ? (
      ...
      <div className="glass rounded-2xl p-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-300 font-medium">No weight entries yet</p>
            <p className="text-gray-500 text-sm mt-2">Start logging to see your progress chart</p>
          </div>
        ) : (
          <div>
            {/* SVG Chart */}
