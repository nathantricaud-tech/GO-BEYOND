...
export default function Home() {
    ...
    return (
      <div className="min-h-screen bg-mesh flex items-center justify-center">
        <div className="text-center animate-fade-up">
          ...
          <p className="text-gray-400 mt-4">Chargement de GO BEYOND...</p>
        </div>
      </div>
    );
  }
  ...
  const tabs: { id: TabType; label: string; emoji: string }[] = [
    ...
    { id: "training", label: "Sport", emoji: "🏋️" },
    { id: "nutrition", label: "Nutrition", emoji: "🥗" },
    { id: "recipes", label: "Recettes", emoji: "🍳" },
    { id: "progress", label: "Progrès", emoji: "📊" },
  ];
  ...
  return (
    <div className="min-h-screen bg-mesh pb-24 sm:pb-6">
      ...
      <main key={activeTab} className="max-w-4xl mx-auto px-4 py-6 tab-transition">
        ...
        {activeTab === "recipes" && <Recipes userGoal={profile.goal} />}
        {activeTab === "progress" && <WeightTracker profile={profile} />}
      </main>
