...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { name, age, weight, height, gender, activityLevel, goal, targetWeight, avatar } = body;
...
export async function PUT(request: NextRequest) {
  ...
  try {
    const body = await request.json();
    const { id, name, age, weight, height, gender, activityLevel, goal, targetWeight, avatar } = body;
